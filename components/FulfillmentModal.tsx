          ...
          {!isCandidate && !isFulfiller ? (
            <div className="text-center space-y-6 py-4">
               ...
               <div>
                   ...
                   {request.productUrl && (
                      <a href={request.productUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-6 py-3 bg-indigo-100 text-indigo-700 font-bold rounded-xl text-sm hover:bg-indigo-200 transition-colors mb-4 border border-indigo-200 shadow-sm w-full justify-center">
                         <ShoppingCart className="w-4 h-4" /> View Item on Store
                      </a>
                   )}
